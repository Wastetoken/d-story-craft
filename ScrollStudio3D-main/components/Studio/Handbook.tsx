      ...
      <div className="relative w-full max-w-5xl max-h-[90vh] bg-[#0a0a0a] border border-zinc-800/50 rounded-[2.5rem] flex flex-col overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,1)] animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="flex-1 min-h-0 flex flex-col md:flex-row">
          ...
          <div className="flex-1 min-h-0 overflow-y-auto p-12 space-y-12 bg-gradient-to-br from-transparent to-white/[0.01]">
            ...
            {activeTab === 'canvas' && (
              <div className="space-y-10">
                <TutorialSection title="Viewport Safe Zone" icon="fa-crop-simple">
                  <p>The <b className="text-white">Safe Zone</b> is a permanent viewport outline that is always visible in edit mode. White corner brackets mark the exact viewport boundary — anything outside this frame will not appear in the final preview or export.</p>
                  <p>Use the safe zone to line up your 3D model and camera with precision. It's your composition guide for creating scroll-driven experiences.</p>
                </TutorialSection>

                <TutorialSection title="DOM Sections Overview" icon="fa-object-group">
                  <p>DOM Sections are HTML content overlays that appear within the safe zone during the scroll. They're how you add text, calls to action, and storytelling elements to your experience.</p>
                  <p>Think of it like compositing titles over video — the 3D scene is the backdrop, and your content floats over it within the safe zone.</p>
                </TutorialSection>
                ...
                <TutorialSection title="Direct Canvas Editing" icon="fa-hand-pointer">
                  ...
                  <ul className="list-disc pl-4 space-y-2">
                    <li><b className="text-white">Click</b> a section to select it. Amber selection brackets and resize handles appear.</li>
                    <li><b className="text-white">Drag</b> the section body to reposition it anywhere within the safe zone. Position is stored as viewport percentages.</li>
                ...
                <TutorialSection title="Selection Brackets" icon="fa-vector-square">
                  <p>When a section is selected, <b className="text-white">amber corner brackets</b> appear around its edges. These highlight the element's exact bounding box so you can align content precisely within the safe zone.</p>
                </TutorialSection>
              ...
              <div className="space-y-10">
                ...
                <TutorialSection title="What Gets Exported" icon="fa-list-check">
                  ...
                  <ul className="list-disc pl-4 space-y-2">
                    ...
                    <li>Page chrome (nav bar, footer, background, progress bar)</li>
